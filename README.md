...
- **Прямое скачивание через бэкенд (`/api/tasks/{task_id}/download`)**: мобильный браузер скачивает файлы методичек прямо на телефон через сессионный прокси FastAPI без повторного ввода логина и пароля от Blackboard!
